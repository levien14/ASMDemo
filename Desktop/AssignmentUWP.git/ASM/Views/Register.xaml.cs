...
namespace ASM.Views
{
    ...
    public sealed partial class Register : Page
    {
        ...
        private async void Do_Register(object sender, RoutedEventArgs e)
        {
            ...
            {
                formRegister.Visibility = Visibility.Collapsed;
                formRegister.Visibility = Visibility.Visible;
            }
            else
            {
                ErrorResponse errorResponse = JsonConvert.DeserializeObject<ErrorResponse>(contents);
                Debug.WriteLine(errorResponse.message);
        ...
        private void Do_SignIn(object sender, RoutedEventArgs e)
        {
